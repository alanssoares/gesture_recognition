...
bool Vector::objectWithin(const Vector object)
{
	if( (object.x < x+limitRaio) && (object.x > x-limitRaio)
		&& (object.y > y-limitRaio) && (y  < object.y+limitRaio)){
...
float Line::getDistanceWithPoint( Vector pos )
{
    ...
    //ccerr << "Line::getDistPoint d1 " << dist1 << " d2 " << dist2 << " d " << dist1 - dist2 << "\n";
