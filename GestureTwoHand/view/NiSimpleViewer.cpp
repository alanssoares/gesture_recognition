...
void
SimpleViewer::glutDisplay (void)
{
	Instance().Display();
}

void
SimpleViewer::glutKeyboard (unsigned char key, int x, int y)
{
...
void
SimpleViewer::DestroyInstance(SimpleViewer& instance)
{
	assert(sm_pInstance);
...
XnStatus
SimpleViewer::Init(int argc, char **argv)
{
	XnStatus rc;
...
SimpleViewer::OnKey(unsigned char key, int /*x*/, int /*y*/)
{
	...
	switch (key){
        ...
        case 'a':
        	...
        	gesture.m_RotateLeft = true;
        	break;
       	case 'd':
       		gesture.m_PosCamera.X += f;
       		gesture.m_RotateRight = true;
       		break;
       	case 'w':
       		gesture.m_PosCamera.Y -= f;
       		gesture.m_RotateUp = true;
       		break;
       	case 's':
       		gesture.m_PosCamera.Y += f;
       		gesture.m_RotateDown = true;
       		break;
       	case 'e':
